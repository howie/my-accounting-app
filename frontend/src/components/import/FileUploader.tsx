...
export default function FileUploader({ ledgerId, onPreviewLoaded }: FileUploaderProps) {
    ...
    const handleUpload = async () => {
        ...
        try {
            const response = await importApi.createPreview(ledgerId, file, importType)
            ...
            <div className="space-y-4">
                <div>
                    ...
                    >
                        ...
                        <option value={ImportType.CREDIT_CARD} disabled>Credit Card Statement (Coming Soon)</option>
                    </select>
                </div>
                ...
                <button
                    ...
                    className={`w-full py-2 px-4 rounded-md text-white font-medium transition-colors ${!file || loading
