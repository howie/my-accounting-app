...
```json
{
  ...
  "accounts": [
    ...
    {"name": "Living Expenses", "type": "EXPENSE", "children": [
...
{
  "transactions": [
    {"type": "INCOME", "from": "Salary", "to": "Bank", "amount": 5000, "desc": "Monthly salary"},
    {"type": "TRANSFER", "from": "Bank", "to": "Cash", "amount": 500, "desc": "ATM withdrawal"},
    {"type": "EXPENSE", "from": "Cash", "to": "Electricity", "amount": 100, "desc": "Electric bill"}
  ]
}
```
